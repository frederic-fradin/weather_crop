...
def load_GFS_analysis(select_date: str, place: str) -> object:
    ...
    url4 = (
        f"https://www.worldagweather.com/pastwx/pastpcp_anom_{id_place}_14day_{id4}.png"
    )
...
def load_crop_analysis(select_date: str, place: str) -> object:
    ...
    url3 = (
        f"https://www.worldagweather.com/crops/fcstwx/fcstpcpmap_{id_place}_{id2}.png"
    )
